              ...
              <div className='hidden lg:block'>
                <div className='relative'>
                  ...
                  <input
                    ...
                    className='w-64 rounded-lg border border-gray-200 bg-gray-50 py-2 pl-10 pr-4 text-sm text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500'
