...
export function ToolCard({ tool }: ToolCardProps) {
  ...
  return (
    <Link href={tool.linkUrl} target='_blank' rel='noopener noreferrer' className='group'>
      <div className='flex items-center justify-between rounded-lg border border-gray-200 bg-white p-4 transition-all duration-200 hover:border-blue-500 hover:shadow-sm'>
